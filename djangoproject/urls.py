...
from lineascomun import views as ExcedenteViews
# from apps.excedente_franquicia import views as excedente_franquicia_views
...
urlpatterns = [
    ...
    # path('log/', include('apps.history.urls')),
    # User and Registration urls
    path('', ExcedenteViews.InternoCreateViajeView.as_view(), name='root'),
    path('excedente_franquicia/', include('apps.excedente_franquicia.urls')),
